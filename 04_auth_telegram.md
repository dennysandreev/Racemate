...
- сессии: практики, квалификация, спринт, гонка, переносы и результаты;
- время напоминаний: за 24 часа, 1 час и 15 минут;
- фэнтези: открытие, незаполненный прогноз, дедлайн, блокировка, начисление очков и место в общем рейтинге;
- новости: важные, любимые пилоты и команда, переходы, стюарды, техника и дневной дайджест;
- погода: заметные изменения, дождь, жара и возможная задержка;
- чемпионат: обновление таблицы после этапа;
- общие: тихие часы и мгновенная отправка или дайджест.
