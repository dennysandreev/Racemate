...
COPY --from=builder /app/src/lib/replay-pit-lane.mjs ./src/lib/replay-pit-lane.mjs
COPY --from=builder /app/src/data/replay-pit-layouts.json ./src/data/replay-pit-layouts.json
